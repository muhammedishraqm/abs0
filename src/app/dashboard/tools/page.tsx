        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center p-6 bg-zinc-950/20 backdrop-blur-[2px]">
          <Card className="max-w-md w-full bg-zinc-900 border-zinc-800 shadow-[0_0_50px_rgba(16,185,129,0.15)] border-t-emerald-500/50">
            <CardHeader className="text-center space-y-2">
              ...
              <CardTitle className="text-2xl font-bold text-white">Unlock AI Factory</CardTitle>
              <p className="text-zinc-400 text-sm">
                Deploy and manage your custom AI workflows, API integrations, and autonomous agents in one high-performance interface.
              </p>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-zinc-950 rounded-lg border border-zinc-800/50 text-center">
                  <div className="text-xs text-zinc-500 mb-1">Custom Bots</div>
                  <Check className="h-4 w-4 text-emerald-500 mx-auto" />
                </div>
                <div className="p-3 bg-zinc-950 rounded-lg border border-zinc-800/50 text-center">
                  <div className="text-xs text-zinc-500 mb-1">API Hooks</div>
                  <Check className="h-4 w-4 text-emerald-500 mx-auto" />
                </div>
              </div>
              <Button 
